...
public class Constant {
    ...
    public static final String APPID = "yUaLIjBL3CscN8Rfs2UffjmDlH8a";
    public static final String SECRET = "ca8oGw9t0IDMq1BPMYJBem1VW3Ua";
    ...
    public static final String DEVICE_DATA = BASE_URL + "/iocm/app/dm/v1.4.0/devices";
    /*
     * Signaling Delivery：
     * 1. POST_ASYN_CMD
     * 2. QUERY_DEVICE_CMD
